...
from data_loading import get_source_loader
...
class RMT(TTAMethod):
    def __init__(self, cfg, model, num_classes):
        ...
        self.use_prototype = cfg.RMT.USE_PROTOTYPE
    ...
    def forward_and_adapt(self, x):
        ...
        if self.use_prototype:
            ...
            features = torch.cat([features_test.view(features_test.shape[0], 1, features_test.shape[1]),
                                features_aug_test.view(features_test.shape[0], 1, features_test.shape[1])], dim=1)
