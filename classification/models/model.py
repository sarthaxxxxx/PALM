...
from imagenet_subsets import IMAGENET_A_MASK, IMAGENET_R_MASK, IMAGENET_D109_MASK
...
def get_torchvision_model(model_name, weight_version="IMAGENET1K_V1"):
    ...
    # assert version.parse(torchvision.__version__) >= version.parse("0.11.1"), "Torchvision version has to be >= 0.11.1"
    ...
    # available_models = torchvision.models.get_available_models()    
